...
public data class Webhook(
    ...
    public companion object {
        ...
        private val baseUrl: String
            get() = "https://discord.com/api/${ApiVersion.latest.formatted}"
    ...
    public fun send(client: OkHttpClient, data: WebhookMessageCreate) {
    ...
    public fun send(data: WebhookMessageCreate) {
        send(OkHttpClient(), data)
    }
