...
public class GuildDeletePacket(private val instance: Disko) : ReceivablePacket {

    override fun handlePayloadReceived(gateway: DiskoGateway, data: JsonElement?) {
        if (data == null || !data.isJsonObject) return

        val obj = data.asJsonObject
        val id = obj.maybeGetSnowflake("id") ?: return
        instance.guildManager.handleGuildDelete(gateway, id, obj)
    }
