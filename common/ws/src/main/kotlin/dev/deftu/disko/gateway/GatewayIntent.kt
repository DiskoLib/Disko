...
public enum class GatewayIntent(
    ...
    public companion object : BitsetFlag.BitsetFlagCompanion<GatewayIntent> {
        ...
        public val all: Set<GatewayIntent> by lazy { values.toSet() }
        public val nonPrivileged: Set<GatewayIntent> by lazy { values.filter { !it.isPrivileged }.toSet() }
        public val privileged: Set<GatewayIntent> by lazy { values.filter { it.isPrivileged }.toSet() }
