...
public enum class Permission(
    ...
    public companion object : BitsetFlag.BitsetFlagCompanion<Permission> {

        override val values: Array<Permission>
            get() = values()

        public fun getImplicitPermissions(member: Member): Set<Permission> {
            if (member.isOwner) {
            ...
            for (role in member.roles) {
                ...
                if (Permission.isPresent(permissionBitSet, ADMINISTRATOR)) {
                    return values.toSet()
                }
            }
